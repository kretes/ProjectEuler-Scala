...
class Problem11Test extends FlatSpec with ShouldMatchers {
  "A Problem11 Solution" should "return the correct largest product in the grid" in {
    val grid = Array(
    ...
    Problem11.solution(grid) should be (70600674)
  }
}
