...
class Problem10Test extends FlatSpec with ShouldMatchers {
  ...
  it should "calculate primes below 20" in {
    Problem10.getPrimes(20).reverse should be (List(2, 3,  5,  7,  11,  13,  17,  19))
  }
  ...
  it should "work for sum of primes below 50" in {
    Problem10.solution(50) should be (328)
  }

  it should "work for sum of primes below 100" in {
  ...
  it should "work for sum of primes below 200000" in {
    Problem10.solution(200000L) should be (1709600813)
  }

  //107(Vec) -> 41 (order) -> 20(mem_min) -> 12 (sieve)
  it should "work for sum of primes below 400000" in {
